...
select cast(avg(Total_Sales) as decimal(10,0)) as average_salary from blinkit_data;

select count(*) as total_items from blinkit_data;

select cast(avg(Rating) as decimal(10,2)) as Average_Rateing from blinkit_data;
...
cast(avg(Rating) as decimal(10,2)) as Average_Rateing,
